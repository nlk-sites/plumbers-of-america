                        ...
                        <div class="col1 contest">
                            ...
                            <?php 
								...
								<div class="content contest">
									...
									<div class="side">
										<ul>
											<li><a href="http://www.plumbersforamerica.com/examples/wp-content/themes/plumbers/images/contest/Drawing_Contest_Entry_Form_Final.pdf" target="_blank"><img src="<?php bloginfo('template_url'); ?>/images/contest/entertoday2.jpg" alt="Enter Today" border="0" width="215" height="118" style="margin: 10px auto 0; display: block" /></a></li>
                                            <li class="tips">
                                            <ul>
                                            <?php wp_list_pages('title_li=&child_of=1617'); ?>
                                            <li><br /><a href="http://www.plumbersforamerica.com/examples/healthy-heart-tips"><img src="<?php bloginfo('template_url'); ?>/images/contest/moretips.png" alt="More healthy Tips" border="0" /></a></li>
                                            </ul>
                                            </li>
										 </ul>
									</div>
